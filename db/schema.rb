...
ActiveRecord::Schema.define(version: 20160406165527) do
  ...
  create_table "links", primary_key: "cl_from", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "cl_to"
